  ...
  return(
    ...
    {items.map(item => (
       <article key={item.id}>
           ...
           <button>           
               <a href={`https://api.whatsapp.com/send?phone=5515996479484&text=Olá,%20${item.user.full_name}%20gostei%20do%20${item.link},%20gostaria%20de%20um%20orçamento`} target = "_blank">CU</a>
           </button>
